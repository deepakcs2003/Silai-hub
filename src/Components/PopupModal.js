    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-xl shadow-2xl w-96">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-fs-5 leading-snug tracking-tight font-heading text-gray-800">
                {product.productName}
          </h2>
          <button
            onClick={onClose}
        ...
        <p className="text-gray-600 text-fs-6 leading-relaxed tracking-wide mb-4">Choose your preferred option:</p>
        <div className="space-y-4">
          <button
            onClick={() => handleAddToCart('readymade')}
            className="w-full bg-green-500 text-white py-3 rounded-lg hover:bg-green-600 transition-colors flex items-center justify-center text-fs-6 font-medium leading-snug tracking-wide"
          >
          ...
          <button
            ...
            className="w-full bg-yellow-500 text-white py-3 rounded-lg hover:bg-yellow-600 transition-colors flex items-center justify-center text-fs-6 font-medium leading-snug tracking-wide"
          >
            Tailor Made
          </button>
        </div>
