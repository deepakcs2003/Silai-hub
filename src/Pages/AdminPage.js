    ...
    <div className="flex flex-col bg-gray-100">
      ...
      <header className="bg-blue-600 text-white p-4 flex flex-col sm:flex-row justify-between items-center shadow-md">
        ...
        <input
          type="text"
          placeholder="Search..."
          className="px-4 py-2 w-full sm:w-auto rounded-md text-gray-700 focus:outline-none"
        />
      </header>
      ...
      <section className="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-white shadow-md">
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-md">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link to="/view_product">
              <button className="bg-orange-400 text-white px-4 py-2 rounded-md hover:bg-red-600 transition">
                View Product
              </button>
            </Link>
          </div>
